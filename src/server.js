...
server.post("/api/login", (req, res) => {
    ...
    jwt.sign({ user: user }, "privateKey@123", { expiresIn: '30s' }, (err, token) => {
...
server.listen(port, (err) =>
    err ? console.warn("Servidor no conectado", { "Error": err }) : console.log(`Servidor levantado en http://localhost:${port}`))